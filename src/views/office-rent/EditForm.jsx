...
function EditForm({ selectedParentItem, ...props }) {
    ...
    const editMutation = useMutation({
        mutationFn: (variables) => updateOfficeRents(props?.rowData?.id, variables),
        onSuccess: () => {
            props.onClose();
    ...
    // };
    return (
        <Dialog header="Office Rent Service Form" visible={props.show} maximizable={true} onHide={() => props.onHide()}>
