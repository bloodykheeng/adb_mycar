...
import MuiDataTable from "../../components/general_components/MuiDataTable";
    ...
    const columns = [
        {
            ...
            options: {
                filter: false,
                sort: true,
                setCellProps: () => ({ style: { minWidth: "5%", maxWidth: "5%" } }),
        ...
        },
        {
            ...
            options: {
                filter: true,
                sort: true,
                setCellProps: () => ({ style: { minWidth: "10%" } }),
                customBodyRender: (value) => {
                    // Access the nested property 'name' of the 'office' object
                    return value.name || "No Office";
                },
            },
        },
        {
            ...
            options: {
                ...
                sort: true,
                setCellProps: () => ({ style: { minWidth: "10%" } }),
                customBodyRender: (value) => value.name || "No Vendor",
            },
        },
        {
            name: "office",
            ...
            options: {
                filter: true,
                sort: true,
                customBodyRender: (value) => value.currency || "No Currency",
            },
        },
        {
            name: "office",
            ...
            options: {
                filter: true,
                sort: true,
                customBodyRender: (value) => value.billing_cycle || "No Billing Cycle",
            },
        },
        {
            name: "start_date",
            ...
            options: {
                filter: true,
                sort: true,
                customBodyRender: (value) => (value ? moment(value).format("YYYY-MM-DD HH:mm:ss") : "No Start Date"),
            },
        },
        {
            name: "end_date",
            ...
            options: {
                filter: true,
                sort: true,
                customBodyRender: (value) => (value ? moment(value).format("YYYY-MM-DD HH:mm:ss") : "No End Date"),
            },
        },
        {
            name: "duration",
            ...
            options: {
                ...
                customBodyRender: (value, tableMeta) => {
                    ...
                    const startDate = new Date(rowData[5]); // index of start date
                    let endDate = rowData[6] ? new Date(rowData[6]) : new Date(); // index of end date
                    return calculatePeriod(startDate, endDate) || "Duration not available";
                },
            },
        },
        {
            name: "office.fee_amount",
            label: "Price Per",
            options: {
                filter: true,
                sort: true,
                customBodyRender: (value) => (value ? parseFloat(value).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }) : "No Price Per"),
            },
        },
        {
            name: "details",
            label: "Details",
            options: {
                display: "excluded", // Hiding this column by default
                customBodyRender: (value) => value || "No Details",
            },
        },
        {
            name: "created_by",
            ...
            options: {
                display: "excluded", // Hiding this column by default
                customBodyRender: (value) => value || "No Creator",
            },
        },
        {
            name: "updated_by",
            ...
            options: {
                display: "excluded", // Hiding this column by default
                customBodyRender: (value) => value || "No Updater",
            },
        },
    ];
