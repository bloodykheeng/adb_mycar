...
function EditForm(props) {
    ...
    const editMutation = useMutation({
        mutationFn: (variables) => updateMotorThirdPartie(props?.rowData?.id, variables),
        onSuccess: () => {
            props.onClose();
    ...
    const handleSubmit = async (data) => {
        ...
        formData.append("logo", data.logo); // Assuming 'photo' is the field name for the file upload
    ...
    return (
        <Dialog header="Motor Third Party Form" visible={props.show} onHide={() => props.onHide()}>
