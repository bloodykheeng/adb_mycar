...
function EditForm(props) {
    ...
    const editMutation = useMutation({
        mutationFn: (variables) => updateInspectionFieldCategories(props?.rowData?.id, variables),
        onSuccess: () => {
            props.onClose();
    ...
    return (
        <Dialog header="Inspection Field Categories Form" visible={props.show} maximizable={true} onHide={() => props.onHide()}>
