                            ...
                            <Field name="size">
                                {({ input, meta }) => (
                                    <div className="p-field m-4">
                                        ...
                                        <InputText {...input} id="size" type="number" />
                                        {meta.touched && meta.error && <small className="p-error">{meta.error}</small>}
                                    </div>
                                )}
                            </Field>
                            ...
                            <Field name="room_capacity">
                                {({ input, meta }) => (
                                    <div className="p-field m-4">
                                        ...
                                        <InputText {...input} id="room_capacity" type="number" />
                                        {meta.touched && meta.error && <small className="p-error">{meta.error}</small>}
                                    </div>
                                )}
                            </Field>
                            ...
                            <Field name="payment_terms">
                                {({ input, meta }) => (
                                    <div className="p-field m-4">
                                        ...
                                        <InputTextarea {...input} rows={5} cols={30} id="payment_terms" className={classNames({ "p-invalid": meta.touched && meta.error })} />
                                        {meta.touched && meta.error && <small className="p-error">{meta.error}</small>}
                                    </div>
                                )}
                            </Field>
