...
const MuiTable = ({
    ...
    hideViewPdfRow,
    showViewPdf,
    showDataChangeStatus,
    handleChangeDataStatus,
    hideDataChangeStatusRow,
}) => {
    ...
    //======== Change Data Status ==================
    const createConditionalhideChangeDataStatusIconAction = (rowData) => {
        // console.log('edditing action : ', editingAction)

        let viewDataChangeStatus = showDataChangeStatus && {
            icon: () => (
                <AddTaskIcon
                    style={{ color: "#FFA500", fontWeight: "bold", cursor: "pointer" }} // Bolder icon
                />
            ),
            tooltip: "Change Status",
            onClick: (e, data) => handleChangeDataStatus(e, data),
            isFreeAction: false,
            hidden: typeof hideDataChangeStatusRow === "function" ? hideDataChangeStatusRow(rowData) : false,
        };

        if (viewDataChangeStatus) {
            return viewDataChangeStatus;
        }
    };
    ...
    return (
        <div>
            <MaterialTable
                ...
                actions={[
                    {
                        icon: () => <Checkbox color="primary" checked={filter} onChange={handleMaterialTableCheckboxChange} inputProps={{ "aria-label": "primary checkbox" }} />,
                    ...
                    showDataChangeStatus && ((rowData) => createConditionalhideChangeDataStatusIconAction(rowData)),
